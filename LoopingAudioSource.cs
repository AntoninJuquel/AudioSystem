...
namespace AudioSystem
{
    ...
    public class LoopingAudioSource
    {
        ...
        private readonly float _startMultiplier;
        private readonly float _stopMultiplier;
        ...
        public LoopingAudioSource(AudioSource audioSource, float startMultiplier, float stopMultiplier, bool persist)
        {
            ...
            _startMultiplier = _currentMultiplier = startMultiplier;
        ...
        public void Stop()
        {
            if (AudioSource == null || !AudioSource.isPlaying || Stopping) return;
        ...
        public void Pause()
        {
            if (AudioSource == null || _paused || !AudioSource.isPlaying) return;
            _paused = true;
            AudioSource.Pause();
        }
        ...
        public void Resume()
        {
            if (AudioSource == null || !_paused) return;
            _paused = false;
            AudioSource.UnPause();
        }
        ...
        public bool Update()
        {
            if (AudioSource == null || !AudioSource.isPlaying) return !_paused;
            if ((AudioSource.volume = Mathf.Lerp(_startVolume, TargetVolume, (_timestamp += Time.deltaTime) / _currentMultiplier)) != 0.0f || !Stopping) return false;
            AudioSource.Stop();
            Stopping = false;
            return true;
        }
